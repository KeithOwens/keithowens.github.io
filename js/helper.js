...
var HTMLheaderpRole = '<p>%data%</p><hr>';
...
var HTMLpwelcomeMsg = '<p class="welcome-message">%data%</p>';

var HTMLskillsStart = '<hr><h3 id="skills-h3">Skills at a Glance:</h3><ul id="skills" class="flex-box"></ul>';
...
var HTMLschoolMajor = '<em>Major: %data%';
...
window.addEventListener('load', initializeMap, true);  //Third argument needed to prevent Firefox exception
...
},true);  //Third argument needed to prevent Firefox exception
